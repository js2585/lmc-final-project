const imagePairs = [
  {
    ...
    AnnotatedGuides:
      '1. Red square: unrealistic scenario (truck floating on river)\n2. Blue square: lacking detail (liberty face is lacking facial details)',
  ...
  },
  {
    ...
    AnnotatedGuides:
      '1. Red square: disfigured physical figures (smudged faces)\n2. Blue square: unrealistic scenarios (sand showing, tail looks like leg)',
  ...
  },
  {
    ...
    AnnotatedGuides:
      '1. Red Square: Unrealistic lighting situations (strange reflections from hood to windshield)',
    citation:
  ...
  },
  {
    ...
    AnnotatedGuides:
      '1. Red Squares: disfigured physical figures (smudged faces, 6 fingers, fading fingers)\n2. Blue Squares: jumbled texts',
  ...
  },
  {
    ...
    AnnotatedGuides:
      '1. Red square: lacking detail (both UGA and Georgia Tech uniforms lack detail in color)\n2. Blue square: jumbled text\n3. Green square: unrealistic scenarios (TV looks like it has two screens)',
    citation:
  ...
  },
  {
    ...
    AnnotatedGuides: '1. Green square: jumbled text (also logo on TV)',
    citation:
  ...
  },
  {
    ...
    AnnotatedGuides:
      '1. Red square: disfigured figures (squashed face)\n2. Blue squares: jumbled text',
